  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <div className="mb-12">
          <h2 className="text-4xl font-bold text-primary-700 text-center mb-12">Présentation de Auto-école</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-600 max-w-xl mx-auto md:mx-0">
                Dépôts Pétroliers du Bénin (Auto-école) joue un rôle stratégique dans l'approvisionnement en énergie du Bénin.
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12">
          ...
          >
            <h3 className="text-2xl font-semibold text-primary-700">Notre Histoire</h3>
              ...
              Dépôts Pétroliers du Bénin (Auto-école) est une entreprise leader dans le stockage et la distribution de produits pétroliers au Bénin. Depuis notre création, nous nous sommes engagés à fournir des services de haute qualité tout en maintenant les plus hauts standards de sécurité et de fiabilité.
            </p>
          </motion.div>
