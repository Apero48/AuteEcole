      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <FooterLink to="/activities">Permis Voiture (B)</FooterLink>
              <FooterLink to="/activities/moto">Permis Moto (A)</FooterLink>
              <FooterLink to="/activities/trottinette">Formation Trottinette</FooterLink>
              <FooterLink to="/news">Actualités</FooterLink>
              <FooterLink to="/contact">Contact & Inscription</FooterLink>
            </ul>
          </div>
