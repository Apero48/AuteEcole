...
import { FaMapMarkerAlt, FaUsers, FaBuilding, FaStar } from 'react-icons/fa';

const stats = [
  {
    id: 1,
    title: '794',
    description: "Lieux pour les cours de conduite",
    icon: <FaMapMarkerAlt className="text-4xl" />,
  },
  {
    id: 2,
    title: '747',
    description: "Enseignants salariés diplômés d'État",
  ...
  },
  {
    id: 4,
    title: '94% ',
    description: "Taux de satisfaction élèves",
